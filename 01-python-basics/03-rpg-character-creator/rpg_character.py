...
def create_character(name, strength, intelligence, charisma):
    # 1. Name Validations (Using len and replace instead of 'in')
    ...
    # 4. Character Sheet Output (f-string)
    return f"""{name}
...
# Basic execution using covered concepts:
